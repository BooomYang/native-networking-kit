...
struct NativeNetKitNetworkHarness {
    static func main() async throws {
        ...
        let client = NativeNetClient(engine: URLSessionNativeHttpEngine(session: URLSession(configuration: sessionConfiguration)))
        ...
        print("NativeNetKit network harness passed")
    }
