...
const server = http.createServer((req, res) => {
  ...
  if (url.pathname === "/success") {
    send(res, 200, "success-body", {
      "X-NativeNetKit-Harness": "success",
    });
    return;
  }
  ...
  if (url.pathname === "/delay") {
    ...
    setTimeout(() => {
      send(res, 200, "delayed-body", {
        "X-NativeNetKit-Harness": "delay",
      });
    }, delayMilliseconds);
    return;
  }
  ...
  send(res, 404, "not-found", {
    "X-NativeNetKit-Harness": "not-found",
  });
});
